...
public class ArraySwap {
    ...
    public static void main(String[] args) {
        ...
        swap(nums, 0, 1);
        logger.log(Level.INFO, "Change index 0 and 1: {0}", Arrays.toString(nums)); // [9, 7, 4]

        swap(nums, 1, 2);
        logger.log(Level.INFO, "Change index 1 and 2: {0}", Arrays.toString(nums)); // [9, 4, 7]

        swap(nums, 2, 0);
        logger.log(Level.INFO, "Change index 2 and 0: {0}", Arrays.toString(nums)); // [7, 4, 9]
    }
}
